        ...
        <div class="review form__container">
            <form action="{{route('store-comment')}}" method="POST">
                ...
                <div class="form__element input-text">
                    ...
                    <br/>
                    <input name="name" type="text" maxlength="512" value="{{old('name')}}">
                </div>
                <div class="form__element input-text">
                    <label for="email">Email</label>
                    <br/>
                    <input name="email" type="email" maxlength="512" value="{{old('email')}}">
                </div>
                <div class="form__element input-text">
                    <label for="rating">Rating</label>
                    <br/>
                    <input name="rating" type="text" maxlength="512" value="{{old('rating')}}">
                </div>
                ...
                <div class="form__element input-text">
                    ...
                    <input name="url" type="text" maxlength="255" value="{{old('url')}}">
                </div>
