        ...
        <div class="review form__container">
            <form action="{{route('comment-update', $comment)}}" method="POST">
                ...
                <div class="form__element input-text">
                    ...
                    <br/>
                    <input name="name" type="text" maxlength="512" value="{{old('name') ?? $comment->name}}" required>
                </div>
                <div class="form__element input-text">
                    <label for="email">Email</label>
                    <br/>
                    <input name="email" type="email" maxlength="512" value="{{old('email') ?? $comment->email}}" required>
                </div>
                <div class="form__element input-text">
                    <label for="name">Rating</label>
                    <br/>
                    <input name="rating" type="text" maxlength="512" value="{{old('rating') ?? $comment->rating}}" required>
                </div>
                ...
                <div class="form__element input-text">
                    ...
                    <input name="url" type="text" maxlength="255" value="{{old('url') ?? $comment->url}}" required>
                </div>
                <div class="form__element input-text">
                    <label for="url">Status</label>
                    <input name="status" type="text" maxlength="255" value="{{old('status') ?? $comment->status}}" required>
                </div>
